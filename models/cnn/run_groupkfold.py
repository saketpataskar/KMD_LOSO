...
# -------------------------------------------------------
# 1. Add project root to import path
# -------------------------------------------------------
...
# -------------------------------------------------------
# 3. HARTH dataset path
# -------------------------------------------------------
HARTH_DIR = os.path.join(PROJECT_ROOT, "harth")


# ============================================================
# 4. LOAD + PREPROCESS HARTH DATASET
# ============================================================
...
X = X_cnn
y = yw
groups = subw  # Group by subject ID


# ============================================================
# 5. CONFIGURE GROUP K-FOLD
# ============================================================
k = 5
...
for train_idx, val_idx in gkf.split(X, y, groups):
    fold_number += 1
    print(f"\n===== Fold {fold_number} =====")
    print("Train subjects:", set(groups[train_idx]))
    print("Val subjects:", set(groups[val_idx]))
